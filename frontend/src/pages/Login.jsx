    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .alert-error{padding:11px 14px;border-radius:8px;font-size:0.875rem;margin-bottom:1.2rem;background:#fff1f1;color:#c00;border:1px solid #ffd0d0}
          ...
          <div className="auth-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="field">
                ...
                <input name="password" type="password" placeholder="Your password" autoComplete="current-password" required onChange={handleChange} />
              </div>
